...
* Version: 1.1
*/
function crear_editar_log($ruta_archivo,$contenido,$tipo,$ip,$referer,$userangent){
  ...
  if(file_exists($ruta_archivo)){
    ...
    fwrite($archivo,PHP_EOL.$now->format("d-m-Y H:i:s.u T")." $ip $arr_tipo_log[$tipo] referer: $referer $contenido $userangent");
    fclose($archivo);
  }else{
    mkdir("logs",777,true);
